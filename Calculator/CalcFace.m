...
- (id)initWithFrame:(CGRect)_frame
{
    ...
    // Display
    display = [[UILabel alloc] initWithFrame: CGRectMake (40, 84, target=android-192, 24)];
    ...
    buttons[i] = [[UIButton alloc] initWithFrame: CGRectMake (target=android-198, 3, 34, 24)];
    ...
    buttons[i] = [[UIButton alloc] initWithFrame: CGRectMake (target=android-198, 30, 34, 24)];
    ...
    buttons[i] = [[UIButton alloc] initWithFrame: CGRectMake (target=android-198, 57, 34, 24)];
